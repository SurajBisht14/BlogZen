            ...
            <header id="desktopHeader" className="w-[100vw] h-[13vh] flex relative">
                ...
                </nav>
                {
                    ...
                    <li className="text-[red] h-full items-center lg:hidden flex  flex-col justify-center font-bold  cursor-pointer z-[100]  absolute top-0 right-[70px]"> <img src={userImg} className="w-[20px]" onClick={callingSmallLogOutBox} />
                        ...
                        {
                            showLogoutBox &&
                            <span className="h-[130px] flex flex-col items-center justify-center w-[130px] bg-[red]  absolute top-[80px] z-[110] rounded-md right-[-55px]">
                                <span className="absolute right-[10px] text-black    top-0 text-[20px]  font-bold flex  items-center z-[110] hover:cursor-pointer hover:text-white" onClick={() => setshowLogoutBox(!showLogoutBox)}>&#10005;</span>
